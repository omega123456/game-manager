      ...
      >
        <div className="relative aspect-[3/4] overflow-hidden bg-surface-high">
          {coverUrl ? (
            ...
            <div className="flex h-full items-center justify-center bg-gradient-to-br from-primary/20 via-transparent to-secondary/15">
          ...
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-background/90 via-background/45 to-transparent p-4">
            <span className="inline-flex items-center gap-1 rounded-full border border-border bg-background/80 px-2 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground backdrop-blur">
              <Icon name={game.lastPlayedAt ? 'history' : 'deployed_code'} className="text-[14px]" />
              {meta.lastPlayed}
            </span>
          </div>
        </div>
        <div className="space-y-3 p-4">
          ...
          <dl className="grid grid-cols-2 gap-2 text-xs text-muted-foreground">
            <div className="rounded-xl bg-surface-low p-3">
              ...
              <dd className="mt-2 text-sm font-medium capitalize text-foreground">{game.monitorMode}</dd>
            </div>
            <div className="rounded-xl bg-surface-low p-3">
